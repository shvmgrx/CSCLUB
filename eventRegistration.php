...
<html lang="en">
  <head>
    ...
    <title>CSclub@jacobs Event Registration</title>
...
<br>
      ...
      <div class="header" id="registration">
        ...
        <h5 class="text-muted">Enter details to create a club</h5>
...
<form action="includes/eventreg.inc.php" method="POST" >
...
<tr>
<td>EVENT TYPE(FREE/PAID):</td>
<td><input type="text" name="eventtype" placeholder="Event Type"></td>
</tr>
<tr>
<td>EVENT DATE:</td>
<td><input type="date" name="eventdate" placeholder="EventDate"></td>
</tr>      
<tr>
