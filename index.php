...
<html lang="en">
  <head>
    ...
    <title>CSclub@jacobs Home</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="header" id="registration">
        <h1>CS Club</h1>
        <h5 class="text-muted">Get involved with the Computer Science Club @ Jacobs University!</h5>
      </div>
...
<div align="center">
<form action="includes/searchStudent.inc.php" method="GET" >
   Search students: <input type="submit" name="SearchStudent">
</form>
<br>

<form action="includes/searchEvent.inc.php" method="GET" >
   Search events: <input type="submit" name="SearchEvent">
</form>
</div>
<br>
<br>
